...
- [ ] **S2 — Email-body legibility: preserve paragraph structure in the shared normalizer** *(S7/S9 device finding #2)*
- [ ] **S3 — The transactional treatment: §24's fifth rung** *(S7 device finding #1; Jon's call 2026-09-18 — add a treatment)*
